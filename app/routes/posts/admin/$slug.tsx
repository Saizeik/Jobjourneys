...
export const action: ActionFunction = async ({ request, params }) => {
  ...
  const errors: ActionData = {
    ...
    coordinates: coordinates ? null : "Coordinates is required",
  ...
  invariant(typeof coordinates === "string", "coordinates must be a string");
  invariant(typeof markdown === "string", "markdown must be a string");
  invariant(typeof userId === "string", "userId must be a string");

  if (params.slug === "new") {
    await createPost({ title, slug, coordinates, markdown, userId });
  } else {
...
export default function NewPostRoute() {
  ...
  return (
    <div className="max-w-xl rounded-md bg-gray-900 p-6 text-yellow-50">
      <Form method="post" key={data.post?.slug ?? "new"}>
        ...
        <p>
          ...
          <input
            ...
            defaultValue={data.post?.coordinates}
          />
        </p>
