...
import { createPasswordResetToken, createUser,getUserByEmail, getUserById,   } from "~/models/user.server";
...
export default function ResetPasswordForm() {
  ...
  if (actionData?.success) {
    return <p>Password reset successful. You can now log in with your new password.</p>;
  }
